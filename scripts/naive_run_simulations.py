...
from src.naive_dgps import DatasetGenerator
from src.naive_simulation import run_simulation, save_simulation_output, true_tau
...
SimulationScenario = namedtuple(
    "SimulationScenario", ["rng", "core_count", "n", "N", "n_sim"]
)
...
if __name__ == "__main__":
    ...
    scenarios = [
        SimulationScenario(spawned_rng[i], core_count, *scenario, nsim)
